...
reader.ReadString("anim_attack_idle_1")
reader.ReadString("anim_attack_start_1")
reader.ReadString("anim_attack_finish_1")
reader.ReadString("anim_attack_melee_1")
reader.ReadString("anim_attack_combo1_str")
reader.ReadString("anim_attack_combo2_str")
reader.ReadString("anim_attack_combo3_str")
reader.ReadString("anim_attack_combo_out1_str")
reader.ReadString("anim_attack_combo_out2_str")
reader.ReadString("attack_to_idle")
reader.ReadHintStr("snd_draw", "sound")
reader.ReadHintStr("snd_holster", "sound")
reader.ReadHintStr("snd_attack_0", "sound")
reader.ReadHintStr("snd_attack_1", "sound")
reader.ReadHintStr("snd_melee_attack", "sound")
reader.ReadString("event_throwing_hit")
reader.ReadString("event_melee_hit")
reader.ReadString("show_knife")
reader.ReadFP32("dispersion")
reader.ReadU32("max_in_slot")
...
reader.ReadFP32("fire_distance")
reader.ReadFP32("bullet_speed")
reader.ReadFP32("melee_power")
reader.ReadFP32("melee_impulse")
reader.ReadFP32("melee_distance")
reader.ReadHintStr("track_throw_in", "camera_track, str_shared")
reader.ReadHintStr("track_throw_out", "camera_track, str_shared")
reader.ReadHintStr("track_melee", "camera_track, str_shared")
...
reader.ReadHintStr("inhand_knife_bone_1", "bone_id")
reader.ReadHintStr("inhand_knife_bone_2", "bone_id")
reader.ReadHintStr("inhand_knife_bone_3", "bone_id")
reader.ReadHintStr("inhand_knife_bone_4", "bone_id")
reader.ReadHintStr("weapon_knife_bone", "bone_id")
