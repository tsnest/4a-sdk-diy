...
reader.ReadHintStr("hud_visual", "ref_model")
reader.ReadString("anim_time")
reader.ReadString("event_hit_melee")
reader.ReadString("event_hit_alt")
reader.ReadU32("snd_knife_ai_type")
reader.ReadU32("snd_melee_ai_type")
reader.ReadHintStr("snd_attack_knife", "sound")
reader.ReadHintStr("snd_attack_melee", "sound")
reader.ReadString("anim_idle")
reader.ReadString("anim_idle_walk")
reader.ReadString("anim_idle_run")
reader.ReadString("anim_idle_sprint")
...
reader.ReadString("anim_draw")
reader.ReadString("anim_holster")
reader.ReadString("anim_attack_0_0")
reader.ReadString("anim_attack_0_1")
reader.ReadString("anim_attack_1_0")
reader.ReadString("anim_attack_1_1")
reader.ReadString("anim_attack_2_0")
reader.ReadString("anim_attack_hand")
reader.ReadHintStr("camera_track_attack_0_0", "camera_track, str_shared")
reader.ReadHintStr("camera_track_attack_0_1", "camera_track, str_shared")
reader.ReadHintStr("camera_track_attack_1_0", "camera_track, str_shared")
reader.ReadHintStr("camera_track_attack_1_1", "camera_track, str_shared")
reader.ReadHintStr("camera_track_attack_2_0", "camera_track, str_shared")
reader.ReadHintStr("camera_track_attack_hand_0", "camera_track, str_shared")
reader.ReadHintStr("camera_track_attack_hand_1", "camera_track, str_shared")
reader.ReadHintStr("camera_track_attack_hand_2", "camera_track, str_shared")
reader.ReadFP32("hit_impulse")
reader.ReadFP32("hit_power")
reader.ReadString("knife_ammo_class")
var section7 = reader.ReadSection("knife_ammo_class")
