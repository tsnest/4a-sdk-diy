...
reader.ReadFP32("min_heating")
reader.ReadFP32("max_heating")
reader.ReadFP32("heating_speed")
reader.ReadFP32("cooling_speed")
reader.ReadString("anim_oblom")
reader.ReadString("anim_quick_reload")
reader.ReadU32("snd_oblom_ai_type")
reader.ReadHintStr("snd_oblom_prefix", "sound")
reader.ReadHintStr("snd_oblom_crack_prefix", "sound")
reader.ReadHintStr("snd_steam_prefix", "sound")
reader.ReadFP32("snd_steam_max_volume")
...
reader.ReadHintStr("bone_part_mech", "part_id")
reader.ReadHintStr("anim_mech_oblom", "animation_str")
reader.ReadHintStr("oblom_camera_track", "camera_track, str_shared")
reader.ReadHintStr("anim_empty", "animation_str")
reader.ReadHintStr("anim_quick_reload", "animation_str")
reader.ReadHintStr("reload_quick_camera_track", "camera_track, str_shared")
reader.ReadHintStr("anim_mech_up", "animation_str")
reader.ReadHintStr("anim_mech_down", "animation_str")
reader.ReadHintStr("anim_mech_reload", "animation_str")
reader.ReadString("anim_oboyma_idle_prefix")
reader.ReadString("anim_oboyma_reload_prefix")
reader.ReadString("bone_patron_prefix")
reader.ReadHintStr("bone_klapan", "bone_id")
reader.ReadHintStr("steam_particles", "particles, str_shared")
