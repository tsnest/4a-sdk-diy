...
reader.ReadString("anim_butt_hit_combo")
reader.ReadString("anim_butt_hit_combo_ext")
reader.ReadString("action_shtyk_hit_combo")
reader.ReadString("anim_reload_left_in")
reader.ReadString("anim_reload_right_in")
reader.ReadString("anim_reload_shell")
reader.ReadString("anim_reload_right_to_left")
reader.ReadString("anim_reload_left_out")
reader.ReadString("anim_reload_right_out")
reader.ReadString("anim_reload_fast")
reader.ReadString("anim_shoot_empty")
reader.ReadString("anim_hit_heavy_in")
reader.ReadString("anim_hit_heavy_idle")
reader.ReadString("anim_hit_heavy")
reader.ReadString("anim_hit_heavy_yes")
reader.ReadString("anim_hit_heavy_no")
reader.ReadString("anim_hitb_heavy_in")
reader.ReadString("anim_hitb_heavy_idle")
reader.ReadString("anim_hitb_heavy")
reader.ReadString("anim_hitb_heavy_yes")
reader.ReadString("anim_hitb_heavy_no")
reader.ReadString("event_reload_shell")
reader.ReadString("event_rotate_baraban")
reader.ReadString("event_hit")
reader.ReadString("event_branch")
reader.ReadString("event_start")
reader.ReadFP32("hit_hit_power")
reader.ReadFP32("hit_hit_impulse")
reader.ReadFP32("hit_hit_range")
reader.ReadFP32("hit_heavy_boost")
reader.ReadFP32("hit_hit_power_shtyk")
reader.ReadFP32("hit_hit_impulse_shtyk")
reader.ReadFP32("hit_hit_range_shtyk")
reader.ReadFP32("hit_heavy_boost_shtyk")
...
reader.ReadHintStr("bone_patron_shoot", "bone_id")
reader.ReadHintStr("bone_patron_reload", "bone_id")
reader.ReadHintStr("bone_part_mehanism", "part_id")
reader.ReadHintStr("bone_part_baraban", "part_id")
reader.ReadHintStr("bone_part_patron_shoot", "part_id")
reader.ReadHintStr("bone_part_patron_reload", "part_id")
reader.ReadString("anim_baraban_idle_prefix")
reader.ReadHintStr("anim_mehanism_shoot", "animation_str")
reader.ReadString("anim_baraban_shoot_prefix")
reader.ReadString("anim_patron_shoot_prefix")
reader.ReadString("anim_reload_shell")
reader.ReadHintStr("anim_shoot_empty", "animation_str")
reader.ReadString("bone_butt")
reader.ReadVec3("butt_point")
reader.ReadString("bone_bayonet")
reader.ReadVec3("bayonet_point")
