...
var section7 = reader.ReadSection("actor_firsteye_cam")
...
var section8 = reader.ReadSection("actor_ladder_cam")
...
var section9 = reader.ReadSection("actor_look_cam")
...
section9.ReadVec2("lim_zoom")
section9.ReadFP32("zoom_speed")
var section10 = reader.ReadSection("actor_free_cam")
...
section10.ReadVec2("lim_zoom")
section10.ReadFP32("zoom_speed")
var section11 = reader.ReadSection("actor_station_cam")
section11.ReadVec2("lim_yaw")
section11.ReadVec2("lim_pitch")
section11.ReadVec2("lim_roll")
section11.ReadBool("first_eye")
section11.ReadFP32("limit_factor")
section11.ReadFP32("limit_pitch_factor")
section11.ReadFP32("limit_pitch_min_ratio")
var section12 = reader.ReadSection("actor_locked_cam")
section12.ReadVec2("lim_yaw")
section12.ReadVec2("lim_pitch")
section12.ReadVec2("lim_roll")
section12.ReadBool("first_eye")
section12.ReadFP32("limit_factor")
...
reader.ReadHint("inventory_keys", "array")
var section13 = reader.ReadArray("inventory_keys")
for(var i = 0; section13.More(); i++)
{
	var section14 = section13.ReadSection(RecStr("rec_", i, 4), false)
	section14.ReadU8("priority")
	section14.ReadU8Array("slots")
}
