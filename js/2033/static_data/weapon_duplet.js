...
reader.ReadString("event_reload_shell_left")
reader.ReadString("event_reload_shell_right")
reader.ReadString("event_appear_shell_right")
reader.ReadString("event_attack_boy_left")
reader.ReadString("event_attack_boy_right")
reader.ReadString("anim_reload_left")
reader.ReadString("anim_reload_right")
reader.ReadString("anim_reload_end")
...
reader.ReadHintStr("bone_part_patron_left", "part_id")
reader.ReadHintStr("bone_part_patron_right", "part_id")
reader.ReadHintStr("bone_part_boy_left", "part_id")
reader.ReadHintStr("bone_part_boy_right", "part_id")
reader.ReadHintStr("anim_draw", "animation_str")
reader.ReadHintStr("anim_idle", "animation_str")
reader.ReadHintStr("anim_idle_patron", "animation_str")
reader.ReadHintStr("anim_attack_boy_left", "animation_str")
reader.ReadHintStr("anim_attack_boy_right", "animation_str")
reader.ReadHintStr("anim_reload_begin", "animation_str")
reader.ReadHintStr("anim_reload_left", "animation_str")
reader.ReadHintStr("anim_reload_right", "animation_str")
reader.ReadHintStr("anim_reload_end", "animation_str")
reader.ReadHintStr("camera_track_attack_0", "camera_track, str_shared")
reader.ReadHintStr("camera_track_attack_1", "camera_track, str_shared")
reader.ReadHintStr("camera_track_reload_0", "camera_track, str_shared")
reader.ReadHintStr("camera_track_reload_1", "camera_track, str_shared")
reader.ReadHintStr("camera_track_reload_2", "camera_track, str_shared")
reader.ReadHintStr("camera_track_reload_3", "camera_track, str_shared")
reader.ReadHintStr("patron_left_bone", "bone_id")
reader.ReadHintStr("patron_right_bone", "bone_id")
reader.ReadString("particles_smoke")
reader.ReadHintStr("shell_right_bone", "bone_id")
reader.ReadHintStr("shell_left_bone", "bone_id")
